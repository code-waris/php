			...
			$.getJSON( "data.json", function( data){
			  ...
			  for(var aa in JSONItems)
			  {
			  	tags+="<tr>";
			  	 ...
			  	 tags+="<td><a class='btn btn-primary btn-xs' data-toggle='modal' 			  	 data-target='#editcategory'>Edit</a></td>";
			  	 tags+="</tr>";
			  }
  			  $('#main').append(tags);
			});
...
<div class="container">
  <h2>Category</h2>
  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#editcategory">Open Modal</button>
